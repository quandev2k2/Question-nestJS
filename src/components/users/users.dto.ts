...
import { IsDateLessThanNow, IsNotNumberIsSpecial, CheckDateOfJoining } from "src/common/validatorContraints";
...
export class CreateNewUser {
  ...
  @IsString()
  @IsOptional()
  @ApiProperty({ example: 'Love Animals' })
  description: string;
